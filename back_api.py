...
# Inicializa la aplicación FastAPI con la información personalizada
app = FastAPI(
...
# Monkey patch para atributos faltantes
...
class PredictionInput(BaseModel):
    ...
    sex_Males: int
    # Campo opcional; se calcula si no se envía
...
# Orden de las columnas (debe coincidir con el orden usado en el entrenamiento)
FEATURES_ORDER = [
...
def predict(input_data: PredictionInput):
    try:
        # Preparar el DataFrame con el orden correcto de columnas
        data_dict = {
